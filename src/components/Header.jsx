        ...
        <div className='z-10 sticky top-0 h-20 w-full lg:h-24 py-1 xl:py-1.5 2xl:py-2 bg-mainBG flex items-center border-b-2 border-stone-300'>
            <div className='lg:max-w-7xl w-full px-6 mx-auto flex justify-between items-center'>
                ...
                <div className='flex justify-end gap-2 w-60'>
                    ...
                    (
                        <div className='flex bg-mainRed hover:bg-mainRedDarker cursor-pointer rounded-3xl px-6 py-2 text-stone-50 items-center z-10 ' onClick={() => handleCartClick()}>
                    ...
                    {/* <button className="relative hidden " onClick={() => handleCartClick()}>
                        ...
                        <div className="rounded-full flex justify-center items-center bg-mainText text-xs text-white absolute w-6 h-5 bottom-6 -right-1">
                            {cartCount}
                        </div>
                    </button>
                    <ShoppingCart /> */}
