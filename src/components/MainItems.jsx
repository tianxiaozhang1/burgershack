                ...
                <MainPageItem
                    ...
                    btmContent={
                        <div className="font-bold text-lg flex leading-5 pr-4 mx:0 ml-4 lg:ml-6 h-26 md:h-28 lg:h-34">
                            <div>
                                <div className={`flex text-lg lg:mb-2 lg:text-2xl xl:text-3xl font-black ${patua_one.className}`}>
                ...
                <MainPageItem
                        ...
                        <div className="py-0 h-72 lg:h-82 flex bg-orange-50">
                            <div className={`w-1/3 lg:-mr-4 ml-4 h-full text-xl lg:text-4xl flex items-center justify-end text-end ${bkBold.className}`}>
                                <div>
                                    ...
                                    <div className='-mt-3 lg:-mt-6 text-orange-400'>Pepper</div>
                                    <div className='-mt-3 lg:-mt-6 text-green-600'>Chicken</div>
                                    <div className='-mt-3 lg:-mt-6 text-red-500'>Sandwhich</div>
                                    <div className='-mt-3 lg:-mt-6 text-orange-800'>Combo</div>
                                </div>
                            </div>
                    ...
                    btmContent={
                        <div className="font-bold text-lg flex leading-5 pr-4 mx:0 ml-4 lg:ml-6 h-26 md:h-28 lg:h-34">
                            <div>
                                <div className={`flex text-lg lg:mb-2 lg:text-2xl xl:text-3xl font-black ${patua_one.className}`}>
                                <div className='text-red-600'><div className='hidden md:flex'>NEW&nbsp;</div></div>
