    ...
    return (
        <div className='lg:max-w-7xl mx-auto'>
            <div className="lg:col-span-2">
                <div className="m-4 lg:m-2 lg:flex lg:-mb-1 lg:items-center">

                    <div className='hidden lg:flex lg:w-1/3'><OrderButtons/></div>
                    <div className='flex lg:hidden w-full'><SmallMidOrderButtons/></div>
                    <a href='/menu' className='lg:w-2/3'>
                        <div className=" bg-mainText m-2 rounded-3xl justify-center items-center text-mainBG text-3xl pb-3 md:pb-4 cursor-pointer">

                                <div className={`text-orange-200 lg:text-6xl flex justify-center items-center -mt-1 -mb-3 md:-mb-6 ${bkReg.className}`}>
                                    For the BBQ lo
